...
function display_c(){
var refresh=20000; // Refresh rate in milli seconds
    ...
    <div class= "row">
      <div class="form-inline">
        ...
        <p style="margin-top: 30px; font: italic small-caps bold 25px Georgia, sans-serif;"><b>Search</b></p>       
          ...
          <input type="submit" class="btn btn-success" name= "submit" id="tablelink" style="width: 100px;"> <br> </br>
          <span id='ct' ></span>  

     

<?php echo "<script>document.write(newtime);</script>" ?>; 
        </center>
        </div>
      </div>
    </div>
