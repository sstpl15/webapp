      ...
      <div class="form-inline">
        ...
        <p style="margin-top: 30px; font: italic small-caps bold 25px Georgia, sans-serif;"><b>Search</b></p>       
          ...
          <div class="form-group">
            <input type="text" class="form-control" id ="MAC" name ="MAC" placeholder="Search by Device Address" maxlength="16">
          </div>&nbsp;
          <input type="submit" class="btn btn-success" name= "submit" id="tablelink" style="width: 100px;">
 <span id='ct' ></span><br>
        </center>
        <input type="submit" class="btn btn-success" value="Download" name= "download" id="tablelink" style="width: 100px;">
        </div>
      </div>
    </div>
  </div>
...
$sql =" SELECT  * FROM SSTPL_UP_Data WHERE  MAC like '%$MAC%' ORDER BY id DESC limit $limit";
...
{
$MAC = $_POST['MAC'];
header('Location: MacFilter.php?MAC='.$MAC.'');
...
{
$MAC = $_POST['MAC'];
header('Location: mac-report.php?MAC='.$_GET['MAC'].'');
