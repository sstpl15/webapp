...
<a  href="gasdevice.php">LPG Alarm System</a> 
  ...
  <?php $link1= 'allrecords1.php?email='.$_GET['email'] .'& product='. $_GET['product'] ;?>
    
    <div>
        <center>
            <p><b>Search</b></p>
            <form action="allrecords1.php?email=rj@gmail.com & product=LPG Sensor" >
                From:
        ...
        <table class="table table-striped" id="myTable">
            <thead>
                ...
                <tr>
					...
					<th><a href="allrecords1.php?val=name&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white">Name</font></a></th>
					<th><a href="allrecords1.php?val=email&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white">Email</font></a></th>
				<!--//	<th><a href="allrecords1.php?val=pass&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>">Password</a></th> -->
					<th><a href="allrecords1.php?val=product&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white">Product</font></a></th>
				<!--//	<th><a href="allrecords1.php?val=phone&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>">Phone</a></th>  -->
					<th><a href="allrecords1.php?val=product_address&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white">Product Address</font></a></th>
					<th><a href="allrecords1.php?val=product_type&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white">Product Type</font></a></th>
					<th><a href="allrecords1.php?val=activate&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white">Activate</font></a></th>
					<th><a href="allrecords1.php?val=key&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white"> Key</font></a></th>
					<th><a href="allrecords1.php?val=time&email=<?php echo $_GET['email'];?>&product=<?php echo $_GET['product'];?>"><font style="color:white">Time</font></a></th>
			...
			?>
				...
				if($row['activate']==1) 
						...
						<td><a href="allrecords1.php?id=<?php echo $row['rowid'] ?>&email=<?php echo trim($_GET['email']) ?>&product=<?php echo trim($_GET['product']) ?>" style="text-decoration:none"><input type="submit" value="<?php echo $var ?>" style="width:150px" <?php echo $enbl ?>/> </a></td>
                  
						<td><a href="viewhistory.php?addrs=<?php echo $row['product_address'] ;?>"> View Hystory </a></td>
                    </tr>
          <?php     } $db->close();  ?>
