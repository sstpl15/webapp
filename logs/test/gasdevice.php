...
if(isset($_GET['page'] ) )
  ...
  $sql =<<<EOF
	      SELECT Address as Address,max(rowid) as rowid ,sms_sent as sms_sent , PAYLOAD as PAYLOAD ,DATE(Time) as Date,TIME(Time) as Time from SSTPL_UP_Data where PAYLOAD in('4e47','474c')  group by Address order by rowid DESC
EOF;
// echo $sql;
        ...
        <th>Action</th>
			...
			?>
                    <tr class="danger">
						...
						<?php $var= ($row['PAYLOAD'] =='474c') ? "disabled": "enabled" ?>
