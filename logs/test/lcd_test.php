...
if(isset($_GET['page'] ) )
  ...
  $sql =<<<EOF
	      SELECT Address as Address,max(rowid) as rowid ,sms_sent as sms_sent , PAYLOAD as PAYLOAD ,DATE(Time) as Date,TIME(Time) as Time from SSTPL_UP_Data where PAYLOAD in('0101','0000')  group by Address order by rowid DESC 
EOF;
                    ...
                    <tr class="danger">
						...
						<td><b><div id="div1" style="width:200px" enabled><center><font style="color:white"><b>LCD OFF<b></font></center></div></b></td>
							...
							<td><b><?php echo $row['Date'];?><b></td>
                                                      <td><b><?php echo $row['product_address'];?><b></td>							
						<td><a href="lcd1_test.php?dev=<?php echo $row['Address'];?>">view log<a></td> 
