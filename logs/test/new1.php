...
if(isset($_GET['page'] ) )
  ...
  $sql =<<<EOF
      SELECT PAYLOAD from SSTPL_UP_Data  order by rowid DESC LIMIT 1 ;
EOF;
// echo $sql;
          ...
          <?php   } else  if($row['PAYLOAD'] =='NG')  
				   {
					   ...
					   <tr class="warning">
						...
						<?php $var= ($row['PAYLOAD'] =='GL') ? "disabled": "enabled" ?>
						   ...
						   <td><b><div1 style="background-color:lightgreen"><font style="color:black">GAS LEAKAGE STOP</font></div1><b></td>
